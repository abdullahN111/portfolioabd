...
export const BentoGridItem = ({
  ...
  const leftLists = ["Typescript", "NextJS", "MongoDB", "TailwindCSS"];
  const rightLists = ["ReactJS", "Python", "PHP", "MySQL"];
  ...
  const handleCopy = () => {
    const text = "myselfabdullah360@gmail.com";
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 3 && (
            <div className="flex gap-2 lg:gap-4 w-fit absolute -right-1">
              <div className="flex flex-col gap-2 md:gap-2 lg:gap-3">
                ...
                <span className="lg:py-3 lg:px-2 py-2 px-3 rounded-lg text-center bg-[#10132E]"></span>
              </div>
              <div className="flex flex-col gap-2 md:gap-2 lg:gap-3">
